<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
      ...
      <img src="<?= base_url('include/img/s2p.png') ?>" width="50" height="30" alt="">
      &nbsp;&nbsp; <h5>K3 Logsheet</h5>
      </div>
      <ul class="c-sidebar-nav">
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="<?= base_url() ?>/dashboard">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-border-all"></use>
            </svg> Dashboard<span class="badge badge-info">NEW</span></a></li>
       
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="#">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-clone"></use>
            </svg> Master Equipment</a>
        </li>
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="#">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-calendar"></use>
            </svg> Scheduler</a>
        </li>
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="#">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-notes"></use>
            </svg> Reporting</a>
        </li>
      </ul>
    ...
    <div class="c-sidebar c-sidebar-lg c-sidebar-light c-sidebar-right c-sidebar-overlaid" id="aside">
      <button class="c-sidebar-close c-class-toggler" type="button" data-target="_parent" data-class="c-sidebar-show" responsive="true">
        <svg class="c-icon">
          <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-x"></use>
        </svg>
      </button>
      <ul class="nav nav-tabs nav-underline nav-underline-primary" role="tablist">
        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#timeline" role="tab">
            <svg class="c-icon">
              <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-list"></use>
            </svg></a></li>
        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#messages" role="tab">
            <svg class="c-icon">
              <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-speech"></use>
            </svg></a></li>
        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#settings" role="tab">
            <svg class="c-icon">
              <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-settings"></use>
            </svg></a></li>
      </ul>
      <!-- Tab panes-->
          ...
          <div class="list-group list-group-accent">
            ...
            <div class="list-group-item list-group-item-accent-warning list-group-item-divider">
              ...
              <div>Meeting with <strong>Lucas</strong></div><small class="text-muted mr-3">
                ...
                <svg class="c-icon">
                  <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-location-pin"></use>
            ...
            <div class="list-group-item list-group-item-accent-info">
              ...
              <div>Skype with <strong>Megan</strong></div><small class="text-muted mr-3">
                ...
                <svg class="c-icon">
                  <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-skype"></use>
                </svg>&nbsp; On-line</small>
            </div>
            ...
            <div class="list-group-item list-group-item-accent-danger list-group-item-divider">
              <div>New UI Project - <strong>deadline</strong></div><small class="text-muted mr-3">
                ...
                <svg class="c-icon">
                  <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-home"></use>
                </svg>&nbsp; creativeLabs HQ</small>
              <div class="c-avatars-stack mt-2">
                <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="<?= base_url('include/coreui') ?>/assets/img/avatars/2.jpg" alt="user@email.com"></div>
                <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="<?= base_url('include/coreui') ?>/assets/img/avatars/3.jpg" alt="user@email.com"></div>
                <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="<?= base_url('include/coreui') ?>/assets/img/avatars/4.jpg" alt="user@email.com"></div>
                <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="<?= base_url('include/coreui') ?>/assets/img/avatars/5.jpg" alt="user@email.com"></div>
                <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="<?= base_url('include/coreui') ?>/assets/img/avatars/6.jpg" alt="user@email.com"></div>
              </div>
            </div>
