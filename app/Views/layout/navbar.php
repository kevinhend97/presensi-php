<header class="c-header c-header-light c-header-fixed">
        <ul class="c-header-nav d-md-down-none">
          ...
          <li class="c-header-nav-item px-3"><a class="c-header-nav-link" href="#">Attedances</a></li>
          <li class="c-header-nav-item px-3"><a class="c-header-nav-link" href="#">Members</a></li>
        </ul>
            ...
            <div class="dropdown-menu dropdown-menu-right pt-0">
              <div class="dropdown-header bg-light py-2"><strong>Account</strong></div><a class="dropdown-item" href="#">
                <svg class="c-icon mfe-2">
                  <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-bell"></use>
                </svg> Updates<span class="badge badge-info mfs-auto">42</span></a><a class="dropdown-item" href="#">
                <svg class="c-icon mfe-2">
                  <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-envelope-open"></use>
                </svg> Messages<span class="badge badge-success mfs-auto">42</span></a><a class="dropdown-item" href="#">
                <svg class="c-icon mfe-2">
                  <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-task"></use>
                </svg> Tasks<span class="badge badge-danger mfs-auto">42</span></a><a class="dropdown-item" href="#">
                <svg class="c-icon mfe-2">
                  <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-comment-square"></use>
                </svg> Comments<span class="badge badge-warning mfs-auto">42</span></a>
              <div class="dropdown-header bg-light py-2"><strong>Settings</strong></div><a class="dropdown-item" href="#">
                <svg class="c-icon mfe-2">
                  <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-user"></use>
                </svg> Profile</a><a class="dropdown-item" href="#">
                <svg class="c-icon mfe-2">
                  <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-settings"></use>
                </svg> Settings</a><a class="dropdown-item" href="#">
                <svg class="c-icon mfe-2">
                  <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-credit-card"></use>
                </svg> Payments<span class="badge badge-secondary mfs-auto">42</span></a><a class="dropdown-item" href="#">
                <svg class="c-icon mfe-2">
                  <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-file"></use>
              ...
              <div class="dropdown-divider"></div><a class="dropdown-item" href="#">
                ...
                <svg class="c-icon mfe-2">
                  <use xlink:href="<?= base_url('include/coreui') ?>/vendors/@coreui/icons/svg/free.svg#cil-account-logout"></use>
                </svg> Logout</a>
            </div>
          </li>
        </ul>
